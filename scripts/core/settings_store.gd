...
# ^ a settings model: one typed get/set per persisted option, by design
...
# neutral fallback; the autoload picks a platform-aware default when unset
const DEF_CONTROL_SCHEME := ControlScheme.CLICK
